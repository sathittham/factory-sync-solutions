...
| Variable | Required | Description | Example |
|----------|----------|-------------|---------|
| `ALLOWED_ORIGINS` | Yes | Comma-separated list of allowed CORS origins. | `http://localhost:5173,https://factory-health-check.pages.dev` |
...
|----------|-------------|---------|
| `ALLOWED_ORIGINS` | CORS allowed origins | `https://factory-health-check.pages.dev` |
...
| `ALLOWED_ORIGINS` | `http://localhost:5173` | `https://factory-health-check-staging.pages.dev` | `https://factory-health-check.pages.dev` |
