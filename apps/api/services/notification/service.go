...
// NotifyQuizResult sends an email to the user and a Slack notification.
func (s *Service) NotifyQuizResult(ctx context.Context, assessment *result.Assessment, contactEmail, contactName, companyName string, scores []scoring.DimensionScore) {
	// Track email job
