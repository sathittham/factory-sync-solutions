		...
		<section className="py-16 sm:py-20 bg-secondary/30">
			<div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
				...
				<a
					...
					onClick={() => trackEvent("line_cta_click", { source: "contact_section" })}
...
export function LandingPage() {
	...
	return (
		<div className="min-h-[calc(100vh-3.5rem)]">
					...
					<FadeIn className="max-w-xl" y={32}>
						...
						<div className="flex flex-col sm:flex-row items-start gap-3">
							<Button
								...
								onClick={() => { trackEvent("cta_click", { source: "hero" }); setShowDialog(true); }}
			...
			<BottomCtaSection locale={locale} onCtaClick={() => { trackEvent("cta_click", { source: "bottom" }); setShowDialog(true); }} ctaLabel={t("landing.ctaBottom")} />
