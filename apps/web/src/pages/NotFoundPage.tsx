		...
		<div className="min-h-[calc(100vh-3.5rem)] flex flex-col items-center justify-center p-4">
			<div className="text-center animate-fade-up">
				<div className="relative inline-block mb-6">
					<span className="text-7xl sm:text-[8rem] lg:text-[10rem] font-bold leading-none text-primary/[0.04] select-none">
						404
					</span>
				...
				<p className="text-muted-foreground mb-8 max-w-sm mx-auto text-sm">{t("notFound.desc") || t("notFound.title")}</p>
