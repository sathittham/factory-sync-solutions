  ...
  return (
    <div className="flex min-h-[calc(100vh-3.5rem)] items-center justify-center px-4">
      <div className="w-full max-w-sm text-center">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-foreground mb-2">{t('nav.appName')}</h1>
          <p className="text-base text-muted-foreground">
            {locale === 'th'
              ? 'เข้าสู่ระบบเพื่อดูผลการประเมินโรงงานของคุณ'
              : 'Sign in to view your factory assessment results'}
          </p>
        </div>
