...
function Avatar({
  ...
  return (
    <div
      className={`${sizeClass} rounded-full bg-primary/10 text-primary flex items-center justify-center font-bold uppercase shrink-0`}
    >
      {fallbackChar}
    </div>
  );
    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-52">
          ...
          <DropdownMenuItem
            onClick={() => {
              trackEvent('profile_open', { source: 'desktop_dropdown' });
              setProfileOpen(true);
            }}
            className="gap-2"
    ...
    <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
      ...
      <SheetContent side="right" className="w-72 p-0">
        <SheetHeader className="px-5 pt-5 pb-4 border-b">
          <SheetTitle className="text-left text-base">{t('nav.appName')}</SheetTitle>
        </SheetHeader>
        ...
        <div className="px-5 py-4 border-b bg-muted/20">
          <button
            ...
            onClick={() => {
              setSheetOpen(false);
              trackEvent('profile_open', { source: 'mobile_drawer' });
              setProfileOpen(true);
            }}
        ...
        <nav className="px-3 py-3 space-y-0.5">
          ...
          <Link
            to="/results"
            className={getDrawerLinkClass(pathname, '/results')}
            onClick={() => setSheetOpen(false)}
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="shrink-0">
              <path
                d="M16 8v8M12 11v5M8 14v2M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
          ...
          {isAdmin && (
            <Link
              to="/admin"
              className={getDrawerLinkClass(pathname, '/admin')}
              onClick={() => setSheetOpen(false)}
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="shrink-0">
                <path d="M12 15a3 3 0 100-6 3 3 0 000 6z" stroke="currentColor" strokeWidth="1.5" />
                <path
                  d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 11-2.83 2.83l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 11-4 0v-.09A1.65 1.65 0 009 19.4a1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 11-2.83-2.83l.06-.06A1.65 1.65 0 004.68 15a1.65 1.65 0 00-1.51-1H3a2 2 0 110-4h.09A1.65 1.65 0 004.6 9a1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 112.83-2.83l.06.06A1.65 1.65 0 009 4.68a1.65 1.65 0 001-1.51V3a2 2 0 114 0v.09a1.65 1.65 0 001 1.51 1.65 1.65 0 001.82-.33l.06-.06a2 2 0 112.83 2.83l-.06.06A1.65 1.65 0 0019.4 9c.2.55.68.94 1.27 1H21a2 2 0 110 4h-.09a1.65 1.65 0 00-1.51 1z"
                  stroke="currentColor"
                  strokeWidth="1.5"
                />
              </svg>
          ...
          <button
            ...
            onClick={() => {
              setSheetOpen(false);
              trackEvent('profile_open', { source: 'mobile_nav' });
              setProfileOpen(true);
            }}
    ...
    <footer className="border-t py-5">
      <div className="container flex flex-col items-center gap-3 text-xs text-muted-foreground">
        <div className="flex items-center gap-2">
          ...
          >
            <span className="text-[#06C755]">{lineIcon}</span> Line @factorysyncsolutions
          </a>
        </div>
        <div className="flex flex-col sm:flex-row items-center justify-between w-full gap-2">
          <span>FactorySync Solutions &middot; @factorysyncsolutions</span>
          <FooterLinks
            t={t}
