...
function LineIcon({ size = 20 }: { readonly size?: number }) {
	return (
...
function EmailIcon({ size = 20 }: { readonly size?: number }) {
	return (
		<svg
			width={size}
			height={size}
...
function PhoneIcon({ size = 20 }: { readonly size?: number }) {
	return (
		<svg
			width={size}
			height={size}
...
function ClockIcon({ size = 20 }: { readonly size?: number }) {
	return (
		<svg
			width={size}
			height={size}
